...
namespace ConsoleDraw
{
	public class Cursor
	{
		...
		public void PlaceCursor(int x, int y, char letter, ConsoleColor background = ConsoleColor.Blue)
		{
			...
			WindowManager.WriteText(blinkLetter.ToString(), x, y, ConsoleColor.White, ConsoleColor.Gray);
		...
		void BlinkCursor(object sender, ElapsedEventArgs e)
		{
			...
			{
				WindowManager.WriteText(blinkLetter.ToString(), _x, _y, ConsoleColor.White, ConsoleColor.Gray);
				_cursorShow = true;
			}
		}
